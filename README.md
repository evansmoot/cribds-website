...
- User will need credentials to access firebase:
  ...
  - Change the ```filename = os.path.join(dirname, './scarp-8329-firebase-adminsdk-p2gz4-0b4b10a761.json')``` line in views.py on line 8 to have the same file name as the json file you just downloaded
